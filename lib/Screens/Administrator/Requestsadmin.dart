...
class Requestsadmin extends StatefulWidget with NavigationStates {
  State<StatefulWidget> createState() {
    return RequestsadminState();
  }
}

class RequestsadminState extends State<Requestsadmin> {
  String name = '';
  String id;
  String uid;
  String position;
  ...
  Widget requestList() {
    return FutureBuilder<QuerySnapshot>(
        future: userRef.where("activate", isEqualTo: 1).getDocuments(),
